...
<ul class="nav-menu">
    ...
    <li class="menu-item-has-children"><a href="#">For Authors</a>
    <ul>
    ...
    <li class="menu-item-has-children"><a href="#">Published Book</a>
        <ul>
    ...
    <li class="menu-item-has-children"><a href="<?php echo get_home_url(); ?>/ibj-journals/">IBJ Journals</a>
        <!--<ul>
            <li><a href="<?php echo get_home_url(); ?>/educational-books">Educational Books</a></li>
            <li><a href="<?php echo get_home_url(); ?>/conference-proceedings">Conference Proceedings</a></li>
            <li><a href="<?php echo get_home_url(); ?>/edited-books">Edited Books</a></li>
    ...
    <li class="menu-item-has-children"><a href="#">IBJ Services</a>
        <ul>
